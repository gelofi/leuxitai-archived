    ...
    if(prefixes == null){
     ...
     return message.channel.send(cmd)
      ...
      if (args[0] === "remindme"){
        ...
        .setDescription(`remind yourself the things you need to do.\nUsage: \`${prefix}remindme <time> <reminder>\``)
      ...
      if (args[0] === "music"){
       ...
       .addField(`:tools:  Tools`, "`info`, `avatar`, `poll`, `reddit`, `urban`, `translate`, `embed`, `remindme`")
       ...
       .addField("Leuxitai - v10.4", `[Add me to your server!](https://tinyurl.com/leuxitai) (in ${bot.guilds.size} servers now) \n[Join our server!](https://discord.gg/4VXEXWP) (Get notifications about updates, changelogs, etc.)`)
